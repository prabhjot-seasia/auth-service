...
('0b56d83b-a560-4639-92f5-20cd040c1bcc', 'admin', 'admin@example.com', '$2a$10$Ad.pwcl8HQU/zCGkybxse.76awk.Tp3/IiNXNeAGPoOa0YOvWRXMy', 'Admin', 'User', true, NOW(), NOW()),
('1c67e94c-b671-5740-a3a6-21de151c2cdd', 'user1', 'user1@example.com', '$2a$10$Ad.pwcl8HQU/zCGkybxse.76awk.Tp3/IiNXNeAGPoOa0YOvWRXMy', 'User', 'One', true, NOW(), NOW()),
('2d78fa5d-c782-6851-b4b7-32ef262d3dee', 'user2', 'user2@example.com', '$2a$10$Ad.pwcl8HQU/zCGkybxse.76awk.Tp3/IiNXNeAGPoOa0YOvWRXMy', 'User', 'Two', true, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
